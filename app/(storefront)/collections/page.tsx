...
export const metadata: Metadata = {
  title: "Collections",
  description:
    "Browse Rizal Heritage's curated collections — Batik, Songket and Tenun, Kebaya, Bags, Jewelry, Plates, and Accessories.",
};
    ...
    <div className="container-content pt-32 pb-24">
      ...
      <div className="mb-16 max-w-2xl">
        ...
        <p className="text-muted mt-4">
          Each collection is rooted in a different craft tradition of
          Central Java — pick one to filter the full catalog.
        </p>
      </div>
